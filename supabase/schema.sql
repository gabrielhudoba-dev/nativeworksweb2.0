...
-- ════════════════════════════════════════════════════════════════════════════
-- 5 · PROPOSALS  (Notion is primary store — Supabase keeps sessions + audit)
-- ════════════════════════════════════════════════════════════════════════════

-- Notion OAuth identities that have logged in to Studio
create table "5_users" (
...
create table "5_proposal_events" (
  id                 uuid        primary key default gen_random_uuid(),
...
create table "5_proposal_signatures" (
  id                 uuid        primary key default gen_random_uuid(),
  notion_proposal_id text        not null,
...
-- No public read policies — all access via supabaseAdmin (service role) only
