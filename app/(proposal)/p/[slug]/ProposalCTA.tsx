    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-s2">
        ...
        <a
          ...
          className="group grain bg-prim text-white rounded-xl flex items-center gap-s3 px-s4 py-s3 text-left hover:opacity-95 transition-opacity"
        >
          <span className="shrink-0 grid place-items-center size-s6 rounded-pill bg-white/15">
            <Icon name="check" size="md" />
          </span>
          <span className="flex flex-col gap-0">
            <span className="font-display font-medium text-h5">Agree with proposal</span>
            <span className="font-body text-l2 text-white/60">Let us know via email</span>
          </span>
        </a>
        ...
        <button
          ...
          className="group grain bg-surface rounded-xl flex items-center gap-s3 px-s4 py-s3 text-left hover:bg-surface/70 transition-colors cursor-pointer"
        >
          <span className="shrink-0 grid place-items-center size-s6 rounded-pill bg-prim/5 text-prim/60">
            <Icon name="question" size="md" />
          </span>
          <span className="flex flex-col gap-0">
            <span className="font-display font-medium text-h5 text-prim">I have questions</span>
