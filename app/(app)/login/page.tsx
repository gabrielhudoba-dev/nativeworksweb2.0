      ...
      <div className="w-full max-w-[400px] flex flex-col items-center gap-s6 text-center">
        ...
        <div className="flex flex-col gap-s2">
          ...
          <Text variant="p2" className="text-prim/60">
            Sign in with your Notion account to access the Native Tools.
          </Text>
        </div>
        ...
        <a
          href={authUrl}
          className="w-full flex items-center justify-center gap-s2 bg-prim text-white rounded-lg px-s4 py-s2 font-body text-p3 font-medium transition-opacity hover:opacity-80"
        >
        ...
        <Text variant="l3" className="text-prim/40">
          Only Native Works team members can access this area.
        </Text>
