...
const variantClass: Record<TextVariant, string> = {
  ...
  p2:    "font-body font-normal text-p2 text-prim translate-y-[4.8px]",
  p3:    "font-body font-normal text-p3 text-prim translate-y-[5.6px]",
  l1:    "font-body font-medium text-l1 text-prim translate-y-[5.6px]",
  l2:    "font-body font-medium text-l2 text-prim translate-y-[5.6px]",
