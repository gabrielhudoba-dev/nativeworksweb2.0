    ...
    <>
      ...
      >
        <div className="w-full sm:w-auto">
          ...
          >
            <div
              className="relative flex items-center gap-s2 sm:gap-s5 pl-s2 pr-s3 sm:pl-s3 sm:pr-s5 h-s8 bg-[#D9D9D9]/20 w-full justify-between sm:w-auto sm:justify-start"
