  ...
  return (
    <section style={{ paddingTop: "var(--hero-section-pt)" }}>
      ...
      <div className="px-page max-w-page mx-auto max-sm:pb-s6 sm:pb-0">
        <div className="hero-in pt-0 max-sm:pt-s12 sm:pt-s15 lg:pt-s18 sm:mt-s6 lg:mt-s9 flex flex-col items-start sm:items-center gap-s6 text-left sm:text-center">
