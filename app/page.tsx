...
import { Button, IconButton } from "@/app/components/molecules";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-s9 px-s9 max-w-s15 mx-auto">
        ...
        <div className="grid grid-flow-col auto-cols-[300px] gap-s5 px-s9 snap-x snap-mandatory">
          {[
            ...
            <div key={title} className="bg-surface rounded-lg relative flex flex-col justify-end gap-s6 pt-s6 pb-s8 px-s6 w-[300px] h-[300px] snap-start">
